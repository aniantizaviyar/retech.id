...
import { CustomerPanel, ProductPanel } from "./MasterDataPanels";
import { SubscriptionPanel, TenantPanel } from "./SaasPanels";
...
type BusinessTab = "business-dashboard" | "business-leads" | "business-customers" | "business-contacts" | "business-pipeline" | "business-quotations" | "business-invoices" | "business-payments" | "business-products" | "business-tenants" | "business-subscriptions" | "business-templates";
...
const websiteTabs: Array<{ id: WebsiteTab; label: string; icon: string }> = [
  ...
  { id: "services", label: "Services", icon: "◇" }, { id: "products", label: "Products", icon: "◆" }, { id: "faqs", label: "FAQ", icon: "?" },
...
const businessTabs: Array<{ id: BusinessTab; label: string; icon: string }> = [
  ...
  { id: "business-products", label: "Products & Services", icon: "◇" }, { id: "business-tenants", label: "SaaS Tenants", icon: "T" },
  { id: "business-subscriptions", label: "Subscriptions", icon: "S" }, { id: "business-templates", label: "PDF Templates", icon: "▧" },
];
...
function emptyRecord(resource: CmsResource): CmsRecord {
  ...
  if (resource === "products") return { slug: "", data_id: { eyebrow: "SAAS", title: "", shortTitle: "", summary: "", description: "", heroImage: "", heroAlt: "", audiences: [], features: [], workflow: [], safeguards: [], plans: [], disclaimer: "" }, data_en: { eyebrow: "SAAS", title: "", shortTitle: "", summary: "", description: "", heroImage: "", heroAlt: "", audiences: [], features: [], workflow: [], safeguards: [], plans: [], disclaimer: "" }, published: true, sort_order: 99 };
