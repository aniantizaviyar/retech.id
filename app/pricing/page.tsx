  ...
  return (
    <main>
      ...
      <section className="pricing-comparison">
        <div className="pricing-heading"><div><span className="kicker">02 / MODERN TECHNOLOGY</span><h2>Modern stack.<br /><em>Chosen with purpose.</em></h2></div><p>Harga bukan hanya untuk tampilan. Setiap project mencakup pemilihan arsitektur, implementasi, pengujian, dan handover menggunakan teknologi yang sesuai dengan kebutuhan bisnis.</p></div>
        <div className="comparison-grid">
          <article><span>WEB & BUSINESS SYSTEM</span><h3>Next.js, React & Laravel</h3><p>Frontend modern untuk pengalaman yang cepat dan responsif, dipadukan dengan backend, API, dan database yang disesuaikan dengan workflow.</p><ul><li>Next.js, React, dan TypeScript</li><li>Laravel/PHP dan REST API</li><li>Database SQL dan role management</li><li>SEO, security, dan maintainability</li></ul></article>
          <article><span>MOBILE APPLICATION</span><h3>Flutter for Android & iOS</h3><p>Pengembangan aplikasi mobile lintas platform dengan satu fondasi produk, tanpa mengabaikan pengalaman dan kebutuhan masing-masing perangkat.</p><ul><li>Flutter untuk Android dan iOS</li><li>Backend dan integrasi API</li><li>Testing serta production build</li><li>Bantuan proses submission store</li></ul></article>
        </div>
      </section>
      <section className="pricing-comparison">
        <div className="pricing-heading"><div><span className="kicker">03 / CHOOSE THE RIGHT BUILD</span><h2>CMS manages content.<br /><em>Web apps run processes.</em></h2></div><p>Keduanya memakai database dan login, tetapi tujuan, logika, serta kompleksitas pengembangannya berbeda.</p></div>
        <div className="comparison-grid">
      ...
      <section className="support-pricing">
        <div className="pricing-heading"><div><span className="kicker">04 / SUPPORT & OPERATIONS</span><h2>Keep systems<br /><em>running reliably.</em></h2></div><p>Pilih bantuan insidental atau pengelolaan rutin sesuai kapasitas dan tingkat risiko sistem.</p></div>
      ...
      <section className="hosting-pricing">
        <div className="pricing-heading"><div><span className="kicker">05 / DOMAIN & HOSTING</span><h2>Infrastructure,<br /><em>without hidden ownership.</em></h2></div><p>Domain dan cloud adalah biaya berulang. Akun dan kepemilikan tetap atas nama customer; RETECH membantu setup dan pengelolaannya.</p></div>
