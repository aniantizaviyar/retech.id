...
const packages = [
  ...
  { eyebrow: "CUSTOM APPLICATION", name: "Web & Mobile App", price: "Rp20 juta", description: "Aplikasi custom yang dirancang berdasarkan fitur, integrasi, dan kebutuhan operasional.", features: ["Discovery dan pemetaan fitur", "Frontend, backend, dan API", "Role dan hak akses", "Testing dan deployment", "Dokumentasi dan handover"] },
];
  ...
  return (
    <main>
      ...
      <section className="support-pricing">
        <div className="pricing-heading"><div><span className="kicker">02 / SUPPORT & OPERATIONS</span><h2>Keep systems<br /><em>running reliably.</em></h2></div><p>Pilih bantuan insidental atau pengelolaan rutin sesuai kapasitas dan tingkat risiko sistem.</p></div>
      ...
      <section className="pricing-notes">
        ...
        <div className="pricing-note-grid"><p><strong>Termasuk</strong>Discovery singkat, estimasi pekerjaan, testing, dan handover sesuai ruang lingkup.</p><p><strong>Belum termasuk</strong>Hosting, domain, lisensi, layanan pihak ketiga, pajak, dan pekerjaan di luar scope.</p><p><strong>Maintenance</strong>Garansi bug berbeda dari fitur baru. Maintenance lanjutan dibuat sebagai paket terpisah.</p><p><strong>Ketersediaan</strong>Jadwal dan response time dikonfirmasi sebelum pekerjaan dimulai. Layanan 24/7 tidak termasuk.</p></div>
      </section>
